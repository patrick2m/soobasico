...
export const slides: Slide[] = [
  ...
  { kind: 'image', id: 'i1', src: '/assets/juliameolhando.jpg', alt: 'Júlia me olhando' },
  { kind: 'text', id: 't5', content: `Mas voltando...` },
  { kind: 'text', id: 't6', content: `Tudo começou em 04 de janeiro de 2025...` },
  { kind: 'image', id: 'i2', src: '/assets/juliaspartaninicio.png', alt: 'Começo do time sub21' },
  ...
  { kind: 'image', id: 'i3', src: '/assets/vsvitoria.png', alt: 'Começo do time sub21' },
  ...
  { kind: 'image', id: 'i3', src: '/assets/passeionapraia.jpg', alt: 'Começo do time sub21' },
  ...
  { kind: 'image', id: 'i4', src: '/assets/sorrisojulia.jpg', alt: 'sorriso na praia' },
  ...
  { kind: 'image', id: 'i5', src: '/assets/eutirandofotodearanha.jpg', alt: 'Patrick tirando foto de aranha' },
  ...
  { kind: 'image', id: 'i6', src: '/assets/quintadaboavista.jpg', alt: 'Passeio na quinta da boa vista' },
  { kind: 'text', id: 't30', content: 'Um passeio num parque se transformando num lugar de brincadeiras, inocentes, divertidas.' },
  { kind: 'image', id: 'i7', src: '/assets/novaamerica.jpg', alt: 'Passeio no shopping' },
  ...
  { kind: 'image', id: 'i8', src: '/assets/lancheaposjogopaugrande.jpg', alt: 'Lanche pro velox' },
  ...
  { kind: 'image', id: 'i9', src: '/assets/capacetenorj.jpg', alt: 'Mochilinha na cidade' },
  { kind: 'text', id: 't35', content: 'Minha mochilinha, seja na cidade.' },
  { kind: 'image', id: 'i10', src: '/assets/viagemmagecapacete.jpg', alt: 'Mochilinha na estrada' },
  ...
  { kind: 'image', id: 'i11', src: '/assets/comendofomezero.jpg', alt: 'Fomezero' },
  { kind: 'text', id: 't43', content: 'A primeira que me levou pra sair.' },
  { kind: 'image', id: 'i12', src: '/assets/acai.jpg', alt: 'Açaí' },
  ...
  { kind: 'image', id: 'i13', src: '/assets/boloarcoiris.jpg', alt: 'Bolo Arco-íris' },
  { kind: 'text', id: 't48', content: 'Dela de 12 anos...' },
  { kind: 'image', id: 'i14', src: '/assets/juliacomgato.jpg', alt: 'Júlia com gato' },
  { kind: 'text', id: 't49', content: 'Dela de hoje pra sempre' },
  { kind: 'text', id: 't50', content: 'É fazer o básico, por esse sorriso' },
  { kind: 'image', id: 'i15', src: '/assets/juliasorrindonoshopping.jpg', alt: 'Júlia sorrindo no shopping' },
  { kind: 'text', id: 't51', content: 'Pra ter isso aqui, pra sempre' },
  { kind: 'image', id: 'i16', src: '/assets/maosdadas.jpg', alt: 'Mãos dadas' },
  ...
  { kind: 'image', id: 'i17', src: '/assets/abracadosnobk.jpg', alt: 'Abraço no BK' },
  ...
  { kind: 'image', id: 'i18', src: '/assets/juliasendopedidaemnamoro.jpg', alt: 'Júlia no Oishi' },
  ...
  { kind: 'image', id: 'i19', src: '/assets/fimcinema.jpg', alt: 'Júlia no Oishi' },
